...
<body>
	@php
        ...
        //$appointments->where('booked_by', 'like', '%'.$_GET['s_name'].'%');
        ...
        if(!empty($_GET['s_appointment_date']) && !empty($_GET['s_appointment_date_to'])){
            $appointments
                ->whereDate('created_at', '>=', date('Y-m-d H:i:s', strtotime($_GET['s_appointment_date'])))
                ->whereDate('created_at', '<=', date('Y-m-d H:i:s', strtotime($_GET['s_appointment_date_to'])))
            ;
        }
